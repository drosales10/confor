...
export async function GET(req: NextRequest) {
  ...
  const orderBy: Record<SortKey, "asc" | "desc"> = {
    code: sortOrder,
    name: sortOrder,
    recommendedHarvestType: sortOrder,
    isActive: sortOrder,
    createdAt: sortOrder,
    updatedAt: sortOrder,
  };
  ...
  try {
    const created = await prisma.productType.create({
      data: {
        ...
        minLengthM: parsed.data.minLengthM ?? null,
        maxLengthM: parsed.data.maxLengthM ?? null,
        minSmallEndDiameterCm: parsed.data.minSmallEndDiameterCm ?? null,
        maxSmallEndDiameterCm: parsed.data.maxSmallEndDiameterCm ?? null,
        recommendedHarvestType: parsed.data.recommendedHarvestType,
    ...
    return mapPrismaError(error, "No fue posible crear el tipo de producto");
  }
}
  ...
  try {
    const updated = await prisma.productType.update({
      ...
      data: {
        code: parsed.data.code,
        name: parsed.data.name,
        minLengthM: parsed.data.minLengthM ?? undefined,
        maxLengthM: parsed.data.maxLengthM ?? undefined,
        minSmallEndDiameterCm: parsed.data.minSmallEndDiameterCm ?? undefined,
        maxSmallEndDiameterCm: parsed.data.maxSmallEndDiameterCm ?? undefined,
        recommendedHarvestType: parsed.data.recommendedHarvestType,
    ...
    return mapPrismaError(error, "No fue posible actualizar el tipo de producto");
  }
}
...
export async function DELETE(req: NextRequest) {
  ...
  try {
    await prisma.productType.delete({ where: { id: parsed.data.id } });
    ...
    return mapPrismaError(error, "No fue posible eliminar el tipo de producto");
  }
}
