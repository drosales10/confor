...
export async function GET(req: NextRequest) {
  ...
  const schemes = await prisma.managementScheme.findMany({
    where,
    include: {
      organization: {
  ...
  if (format === "csv") {
    ...
    return new NextResponse(csv, {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="management_schemes_${filenameDate}.csv"`,
      },
    });
  }
  ...
  XLSX.utils.book_append_sheet(workbook, worksheet, "ManagementSchemes");
  ...
  return new NextResponse(body, {
    ...
    headers: {
      ...
      "Content-Disposition": `attachment; filename="management_schemes_${filenameDate}.xlsx"`,
    },
  });
}
