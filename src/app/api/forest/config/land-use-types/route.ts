...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    return mapPrismaError(error, "No fue posible crear el uso de suelos");
  }
}
...
export async function PATCH(req: NextRequest) {
  ...
  try {
    ...
    return mapPrismaError(error, "No fue posible actualizar el uso de suelos");
  }
}
...
export async function DELETE(req: NextRequest) {
  ...
  try {
    await prisma.landUseType.delete({ where: { id: parsed.data.id } });
    ...
    return mapPrismaError(error, "No fue posible eliminar el uso de suelos");
  }
}
