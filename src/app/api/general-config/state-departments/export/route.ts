...
export async function GET(req: NextRequest) {
  ...
  if (format === "csv") {
    ...
    return new NextResponse(csv, {
      ...
      headers: {
        ...
        "Content-Disposition": `attachment; filename="state_departments_${filenameDate}.csv"`,
      },
    });
  }
  ...
  XLSX.utils.book_append_sheet(workbook, worksheet, "StateDepartments");
  ...
  return new NextResponse(body, {
    ...
    headers: {
      ...
      "Content-Disposition": `attachment; filename="state_departments_${filenameDate}.xlsx"`,
    },
  });
}
